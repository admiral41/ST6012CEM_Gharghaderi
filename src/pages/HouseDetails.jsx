...
import ScheduleVisitSlideOver from "./homepageComponent/ScheduleVisitSlideOver";
...
const HouseDetails = () => {
  ...
  const [showSlideOver, setShowSlideOver] = useState(false); // State for controlling Slide-over visibility
    ...
    const detailsTable = `
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <td>${houseData.propertySize} Sq Ft</td>
        </tr>
        <tr>
            ...
            <div className="mt-6 grid gap-4 sm:mt-6 md:mt-8 lg:grid-cols-5 lg:mt-10">
              ...
              <div className="col-span-2">
                <button
                  ...
                  onClick={() =>handleScheduleVisit() } // Open Slide-over on button click
                >
                  SCHEDULE A VISIT
                </button>
              </div>
              {showSlideOver && (
                <ScheduleVisitSlideOver
                  houseData={houseData}
                  onClose={() => setShowSlideOver(false)} // Close Slide-over
                />
              )}
            </div>
          </div>
              ...
              <div className="mt-4 relative bg-white rounded-xl p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 z-10">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="ml-4 sm:mr-4">{houseData.garageSize}</p>
                  </div>
                  <div className="flex justify-between items-center">
                    <p className="font-bold">Property Size:</p>
                    <p className="ml-4 sm:mr-4">
                      {houseData.propertySize} Sq Ft
                    </p>
                  </div>
                  <div className="flex justify-between items-center">
